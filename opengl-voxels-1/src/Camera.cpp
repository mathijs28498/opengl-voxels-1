...
Camera::Camera(GLFWwindow* window, float walkSpeed, float speedMultiplier, float mouseSensitivity, const int WIDTH, const int HEIGHT) {
...
void Camera::setViewMatrix(glm::vec3 cameraPos) {
